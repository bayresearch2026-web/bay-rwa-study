 ...
 *
 * 스터디원 5명 — 장윤선 · 이재환 · 노제희 · 박의혁 · 이성재
 *   신영환님은 4회차(09-01)부터 스터디에서 빠졌습니다. 1~3회차 배분과 진행 기록은
 ...
 *
 *   5명 + 운영자로 회차마다 6파트를 채웁니다. 같은 파트가 4회 이상 겹치거나
...
window.STUDY = {
  ...
  sessions: [
    ...
    /* ===== 4회차 · 디파이 : 탈중앙화 거래소 ==================================*/
    {
      ...
      // 신영환님이 빠지면서 09-01부터 배예림(운영자)이 여섯 번째 자리를 맡습니다.
      assign: [
        { who: '배예림',
          parts: [
            { n: '1.',   t: '토큰화 자산의 거래' },
    ...
    // 파트 표기는 '채권 n' / '대체 n' 으로 어느 아티클의 목차인지 구분합니다.
    {
      ...
      assign: [
        { who: '배예림',
          ...
          focus: '두 아티클의 도입 프레임(시장 규모·권리 구조 / 대체자산의 범위와 문제)과 활용·제도·결론 — 자산 방식 발표들을 앞뒤에서 묶는 역할' },
        ...
        { who: '박의혁',
          ...
          focus: '등기·임대수익이 온체인 지분으로 연결되는 구조 / 실물 보관과 청구권 설계' },

        { who: '노제희',
          parts: [
            { n: '대체 3-3.', t: '수집품: 보관된 실물자산에 대한 권리의 토큰화' }
          ],
          focus: '수집품 토큰화의 권리 구조 / 가치평가와 유동성 문제' },

        { who: '이재환',
          parts: [
            { n: '대체 3-4.', t: '신용: 사모신용과 구조화 신용의 토큰화' }
          ],
