 ...
 *   3·4회차는 박의혁 불참으로 배예림(운영자)이 대신 발표합니다.
 *
...
window.STUDY = {
  ...
  sessions: [
    ...
    /* ===== 1회차 · RWA 토큰화 생태계 분류 =============================== */
    {
      ...
      /* ---- 1회차만 다른 운영 방식 -------------------------------------
       * 첫 회차라 사전 질문 제출을 없애고 발표자 중심으로 진행합니다.
       * 아래 네 값은 defaults를 덮어쓰며, 다른 회차에는 영향이 없습니다.
       * 인당 25분(10+10+5)이라 총 150분입니다.
       * ---------------------------------------------------------------- */
      minutesPerSlot: 25,
      ...
      prep: [
        ...
        { when: 'D-1까지',
          ...
          note: '1회차는 사전 질문 제출이 없습니다. 질문은 각 발표 끝 5분에 즉석으로 합니다' }
      ],
      assign: [
        { who: '이재환',
          parts: [
      ...
      // 발표자를 두지 않는 구간. 담당 배분표에만 표시되고 진행표(180분)에는 들어가지 않습니다.
      extra: [
        { tag: '공통', who: '담당 없음',
          parts: [
            { n: '1.', t: '들어가며' },
