...
장윤선 · 이재환 · 노제희 · 신영환 · 박의혁 · 이성재 (6명, 운영자 제외)

`assign` 배열의 순서가 곧 **Part 번호이자 발표 시간대**입니다. (0번째 = Part 1 = 00–30분)

> ⚠️ **신영환님은 세션 중간에 나가야 하므로 반드시 Part 1~3에 배치**해야 합니다.
> 현재 9회차에 걸쳐 P1·P2·P3 각 3회씩 고르게 배분돼 있습니다.

나머지 5명은 회차마다 무작위 순서이며, 같은 파트가 4회 이상 겹치거나 연속 회차에
